...
let comproot = '/ioBIN/vue-components/'
let thiscomp = {
  name: 'my-component',
  filepath: 'my-component.vue'
}
Vue.component(thiscomp.name,httpVueLoader(`${comproot}${thiscomp.filepath}`))
...
new Vue({
  ...
  methods: {
    ...
    beforeMount() {
      console.log('before mount main static app')
      initHook(self,'todos')
